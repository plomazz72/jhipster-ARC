...
@RestController
@RequestMapping("/api/jhipster-arc-01-kafka")
public class JhipsterArc01KafkaResource {
    private final Logger log = LoggerFactory.getLogger(JhipsterArc01KafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhipsterArc01KafkaResource(KafkaProperties kafkaProperties) {
